...
namespace BehaviorDesigner.Runtime.Tasks.Basic.Math
{
    ...
    public class FloatOperatorPlus : Action
    {
        ...
        [Tooltip("Range of random float to add")]
        public SharedFloat ranAddMin;
        public SharedFloat ranAddMax;
        ...
        public override TaskStatus OnUpdate()
        {
            ...
            storeResult.Value = storeResult.Value + Random.Range(ranAddMin.Value, ranAddMax.Value);
